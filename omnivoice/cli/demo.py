...
def build_demo(
    ...
    css = """
    .gradio-container{max-width:100%!important;font-size:16px!important;background:#0f0f0f!important}
    .gradio-container h1{font-size:1.5em!important}
    .gradio-container .prose{font-size:1.1em!important}
    .compact-audio audio{height:60px!important}
    .compact-audio .waveform{min-height:80px!important}
    .ae-wrap{background:linear-gradient(135deg,#0f0f0f 0%,#1c1500 50%,#0f0f0f 100%);border-bottom:1px solid #2e2e2e;padding:24px 40px 18px;text-align:center;position:relative;margin-bottom:4px}
    .ae-wrap::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse at 50% 0%,rgba(201,168,76,.1) 0%,transparent 65%);pointer-events:none}
    .ae-title{font-size:2em!important;font-weight:800!important;letter-spacing:.05em!important;background:linear-gradient(135deg,#C9A84C,#F0D060,#C9A84C);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin:0!important;line-height:1.2}
    .ae-sub{font-size:.82em;color:#777;letter-spacing:.15em;text-transform:uppercase;margin:5px 0 0}
    button.primary{background:linear-gradient(135deg,#C9A84C,#F0D060,#C9A84C)!important;color:#0f0f0f!important;font-weight:700!important;border:none!important;border-radius:7px!important;box-shadow:0 3px 14px rgba(201,168,76,.3)!important;transition:all .2s!important}
    button.primary:hover{box-shadow:0 5px 22px rgba(201,168,76,.5)!important;transform:translateY(-1px)!important}
    button:not(.primary){background:#1a1a1a!important;color:#C9A84C!important;border:1px solid #333!important;border-radius:6px!important}
    button:not(.primary):hover{border-color:#C9A84C!important;background:#1e1a00!important}
    input,textarea{background:#1a1a1a!important;color:#e0e0e0!important;border:1px solid #333!important;border-radius:6px!important}
    input:focus,textarea:focus{border-color:#C9A84C!important;box-shadow:0 0 0 2px rgba(201,168,76,.12)!important}
    label span,.label-wrap span{color:#C9A84C!important;font-weight:600!important}
    input[type=range],input[type=checkbox]:checked{accent-color:#C9A84C!important}
    .upload-container{background:#1a1a1a!important;border:2px dashed #C9A84C!important;border-radius:8px!important}
    .upload-container p,.upload-container span{color:#C9A84C!important}
    .upload-container svg{stroke:#C9A84C!important}
    .block,.panel{background:#1a1a1a!important;border:1px solid #252525!important;border-radius:8px!important}
    ...
    with gr.Blocks(theme=theme, css=css, title="Automation Empire — AI Voice Studio") as demo:
        gr.HTML("""<div class="ae-wrap">
            <h1 class="ae-title">👑 AUTOMATION EMPIRE 👑</h1>
            <p class="ae-sub">AI Voice Studio &nbsp;·&nbsp; 600+ Languages &nbsp;·&nbsp; Voice Cloning &nbsp;·&nbsp; Voice Design</p>
        </div>""")
